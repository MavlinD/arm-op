...
<form id="${form}" class="passpq mx-auto px-4 py-2 col-12 col-sm-8 col-md-7 col-lg-6 col-xl-4">
  ...
  <button id="${btnSubmit}" type="submit" autofocus class="btn btn-primary px-5 mx-auto d-block my-4" data-a="submit" data-r="submit" disabled="disabled">
    ...
    const handlers = {
        ...
        submit(arg) {
            ...
            if (sels.field_1.value && sels.field_2.value) {
                ...
                let request = query(), body = new FormData()
                body.set('payload', JSON.stringify(request.data))
